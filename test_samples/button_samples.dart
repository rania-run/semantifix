...
// VIOLATION: IconButton missing tooltip
final v1 = IconButton(onPressed: () {}, icon: const Icon(Icons.add));

// OK: IconButton with tooltip
final ok1 = IconButton(
    onPressed: () {}, icon: const Icon(Icons.edit), tooltip: 'Edit item');

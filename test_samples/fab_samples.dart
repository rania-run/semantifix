...
// VIOLATION: FloatingActionButton missing tooltip
final v1 = FloatingActionButton(onPressed: () {}, child: const Icon(Icons.add));

// OK: FloatingActionButton with tooltip
final ok1 = FloatingActionButton(
  onPressed: () {},
  tooltip: 'Add item',
